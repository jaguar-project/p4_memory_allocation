...
control MyVerifyChecksum(inout Metadata meta) {
    apply {  }
}

control ingress(inout H pkt_hdr, inout Metadata metadata) {
...
control MyEgress(inout H pkt_hdr, inout Metadata meta) {
    apply {  }
}

control MyComputeChecksum(inout Metadata meta) {
     apply {  }
}
